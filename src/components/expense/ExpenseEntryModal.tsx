...
import type { ExpenseCategory, ExpenseItem, ExpenseSubCategory } from '@/types'
...
export function ExpenseEntryModal({
  ...
  const handleSubmit = useCallback(() => {
    ...
    setReceiptDate('')
    onClose()
  }, [category, subCategory, storeName, memo, items, totalAmount, currency, receiptDate, onSubmit, onClose])
